...
# Loading libraries
pacman::p_load(tidyverse, gganimate, gapminder, gifski, png)
```
...
If not making it log10, the outlier would affect the visualisation so much, that it is almost impossible to see how the rest of the countries are doing compared to each other in gdpPercap.
When using the log10, this outlier is not affecting the rest of the visualisation as much.
